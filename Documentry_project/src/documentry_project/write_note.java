 ...
 * @author HP
 */
public class write_note extends javax.swing.JFrame {

    /**
     * Creates new form write_note
     */
    public write_note() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(write_note.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new write_note().setVisible(true);
            }
        });
    }
